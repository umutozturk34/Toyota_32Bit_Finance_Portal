...
class MacroIndicatorRegistryServiceTest {
    ...
    void setUp() {
        ...
        properties = new MacroProperties(java.time.LocalDate.of(2024, 1, 1), 10, 1000, null, List.of(definition));
    ...
    void should_returnEmptyList_when_propertiesHaveNoIndicators() {
        MacroProperties empty = new MacroProperties(java.time.LocalDate.now(), 1, 1000, null, List.of());
    ...
    void should_assignCorrectInstrumentType_when_categoryIsDeposit() {
        MacroProperties depositProps = new MacroProperties(java.time.LocalDate.now(), 1, 1000, null, List.of(
