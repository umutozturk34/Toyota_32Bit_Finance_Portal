...
import { X, Info, ArrowLeft, Search, LineChart, Briefcase, ChevronDown, GitCompare, CalendarRange } from 'lucide-react';
        ...
        <div className="flex flex-wrap items-center gap-1 pt-1">
          ...
          <button
            ...
            onClick={() => {
              ...
              setCustomFrom((v) => v || (seed.from < FX_FLOOR_DATE ? FX_FLOOR_DATE : seed.from));
