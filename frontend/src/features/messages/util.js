...
export const CONVERSATION_CLOSED_BANNER_KEY = 'messages.conversationClosedBanner';
export const CONVERSATION_CLOSED_HINT_KEY = 'messages.conversationClosedHint';
